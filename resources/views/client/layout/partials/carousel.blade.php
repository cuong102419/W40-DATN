<section class="home-slider-area">
    <div class="swiper-container home-slider-container default-slider-container mt-4 bg-primary">
        <div class="swiper-wrapper home-slider-wrapper slider-default">
            <div class="swiper-slide">
                <div class="slider-content-area" data-bg-img="{{ asset('client/img/shape/1.webp')}}">
                    <div class="container">
                                    ...
                                    <div class="slider-thumb">
                                        <div class="thumb scene">
                                            <span class="scene-layer" data-depth=".3"><img
                                                    src="{{ asset('client/img/slider/slider-01.webp')}}" width="461"
                                                    height="489" alt="Image-HasTech"></span>
                                        </div>
                                        <div class="shape-group mousemove">
                                            <div class="shape-group-one mousemove-layer" data-speed=".8"
                                                data-bg-img="{{ asset('client/img/shape/2.webp')}}"></div>
                                            <div class="shape-group-two scene"><span class="scene-layer"
                                                    data-depth=".6"><img src="{{ asset('client/img/shape/3.webp')}}"
                                                        width="471" height="462" alt="Image-HasTech"></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="slider-thumb">
                                        <div class="thumb scene">
                                            <span class="scene-layer" data-depth=".3"><img
                                                    src="{{ asset('client/img/slider/slider-03.webp')}}" width="548"
