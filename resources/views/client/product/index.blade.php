                ...
                <div class="shop-sidebar">
                    <div class="shop-sidebar-price-range" style="padding: 30px">
                        ...
                        <div class="sidebar-price-range">
                            ...
                            <button id="filter-price" class="mt-3 btn btn-theme btn-sm mt-2" style=" font-size: 14px;;margin-left: 115px;width: 95px; height: 40px; padding: 10px;"><i class="fa fa-filter me-2" aria-hidden="true"></i>Lọc</button>
                        </div>
                    </div>
                                            ...
                                            <div class="inner-content">
                                                <div class="product-thumb">
                                                    ...
                                                    <div class="product-action">
                                                        <form class="add-wishlist-form" action="{{ route('wishlist.add', $product->id) }}" method="POST">
                                                            @csrf
                                                ...
                                                <div class="product-info">
                                                    <div class="category">
                                                        <ul>
                                                            <li><a href="{{ route('product.detail', ['id' => $product->id, 'slug' => $product->slug]) }}">{{ $product->category->name ?? 'Uncategorized' }}</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <h4 class="title"><a href="{{ route('product.detail', ['id' => $product->id, 'slug' => $product->slug]) }}">{{ $product->name }}</a>
                                                    </h4>
                                                    <div class="prices">
                                                        @if ($product->discount)
                                        ...
                                        <div class="product-item product-list-item">
                                            <div class="inner-content">
                                                ...
                                                <div class="product-info">
                                                    <div class="category">
                                                        <ul>
                                                            <li><a href="#">{{ $product->category->name ?? 'Uncategorized' }}</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <h4 class="title"><a href="{{ route('product.detail', ['id' => $product->id, 'slug' => $product->slug]) }}">{{ $product->name }}</a>
