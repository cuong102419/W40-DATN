            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="product-collection">
                    <div class="inner-content">
                        ...
                        <div class="product-collection-thumb" data-bg-img="{{ asset('client/img/shop/banner/3.webp') }}"></div>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="product-collection">
                    <div class="inner-content">
                        ...
                        <div class="product-collection-thumb" data-bg-img="{{ asset('client/img/shop/banner/1.jpg')}}"></div>
                        <a class="banner-link-overlay" href="shop.html"></a>
                    </div>
                </div>
                <!--== End Product Collection Item ==-->
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="product-collection">
                    <div class="inner-content">
                        ...
                        <div class="product-collection-thumb" data-bg-img="{{ asset('client/img/shop/banner/2.jpg') }}"></div>
                        <a class="banner-link-overlay" href="shop.html"></a>
                    </div>
                </div>
                <!--== End Product Collection Item ==-->
                        ...
                        <div class="inner-content">
                            <div class="product-thumb">
                                <a href="{{ route('product.detail', ['id' => $product->id]) }}">
                                    <img src="{{ asset('client/img/shop/1.webp')}}" width="270" height="274" alt="{{ $product->name }}">
                                </a>
                    ...
                    <div class="inner-content">
                        <div class="product-thumb">
                            <a href="single-product.html">
                                <img src="{{ asset('client/img/shop/2.webp')}}" width="270" height="274"
                                    alt="Image-HasTech">
                            </a>
                            <div class="product-action">
            ...
            <div class="col-sm-6 col-lg-3">
                ...
                <div class="product-item">
                    <div class="inner-content">
                        <div class="product-thumb">
                            <a href="single-product.html">
                                <img src="{{ asset('client/img/shop/8.webp')}}" width="270" height="274"
                                    alt="Image-HasTech">
                            </a>
                            <div class="product-flag">
                                <ul>
